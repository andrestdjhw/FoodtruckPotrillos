      ...
      <div className={`bg-[#1a1a1a] text-gray-300 text-xs transition-all duration-300 overflow-hidden ${isScrolled ? "max-h-0 py-0" : ""}`}>
        ...
        <div className={`sm:hidden transition-all duration-300 ${isScrolled ? "max-h-0" : "max-h-20"} overflow-hidden`}>
          <div className="flex flex-col items-center gap-1 py-2 px-4">
            ...
            {/* Row 2 — Phone + Email */}
            <div className="flex items-center gap-4">
              <a href="tel:+12675966092" className="flex items-center gap-1 hover:text-[#e8a020] transition-colors">
              ...
              <a href="mailto:info@restaurantpotrillos.com" className="flex items-center gap-1 hover:text-[#e8a020] transition-colors">
                <svg className="w-3 h-3 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className={`hidden sm:block transition-all duration-300 ${isScrolled ? "max-h-0 py-0" : "max-h-12 py-2"} overflow-hidden`}>
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-3 items-center">
            ...
            <div className="flex justify-center items-center gap-4">
              <a href="https://maps.google.com/?q=4200+G+St,+Philadelphia,+PA" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-[#e8a020] transition-colors">
                <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4">
          ...
          <a href="/" style={{ flexShrink: 0, lineHeight: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: "2px" }}>
            <img
              ...
              style={{ height: isScrolled ? "24px" : "32px", width: "auto", transition: "height 0.35s ease", display: "block" }}
            />
            <img
              src="/wp-content/uploads/2026/05/Los-Potrillos-_WB-scaled-1.png"
              alt="Los Potrillos"
              style={{ height: isScrolled ? "28px" : "36px", width: "auto", transition: "height 0.35s ease", display: "block" }}
            />
          </a>
